...
public:
    static EquipParamWeapon * GetEquipParamWeapon(int itemId);
...
private:
    ...
    static inline const ParamFunc GetEquipParamProtectorInternal{ (ParamFunc)0x0 };
    static inline const ParamFunc GetEquipParamAccessoryInternal{ (ParamFunc)0x0 };
    static inline const ParamFunc GetEquipParamGoodsInternal{ (ParamFunc)0x0 };

    static void* ReversedGetParams(unsigned int itemId, ParamTableType tableId);
};
